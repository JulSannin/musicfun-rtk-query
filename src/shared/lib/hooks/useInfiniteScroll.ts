    ...
    useEffect(() => {
        ...
        const observer = new IntersectionObserver(
            ...
            },
            {
                ...
                root: null,
                // запас, за который до появления маячка уже начинаем грузить
                // (по умолчанию 100px, вызывающий может задать своё)
                rootMargin,
                // доля видимости маячка, на которой срабатываем (по умолчанию 10%)
                threshold,
            }
        );
